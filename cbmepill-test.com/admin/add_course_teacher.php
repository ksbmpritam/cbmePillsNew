...
if (isset($_POST['submit'])) {
  ...
  $qry = "insert into sub_categories(name,new_line,`desc`,sub_category_image,date,category_id ,order_sc) values('" . $_POST['title'] . "','".$_POST['new_line']."','" . $_POST['description'] . "','" . $sub_category_image . "','" . $today . "','" . $_POST['cat_id'] . "','0')";
