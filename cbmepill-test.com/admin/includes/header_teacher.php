...
" alt="app logo" /></a>
            ...
            <div class="sidebar-menu">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li <?php if ($currentFile == "all_lession_plan.php") { ?>class="active" <?php } ?>> <a href="all_lession_plan.php">
                    ...
                    <li <?php if ($currentFile == "teacher_competency.php" || $currentFile == "teacher_competency.php") { ?>class="active" <?php } ?>>
                        <a href="teacher_competency.php">
                    ...
                    <!-- <li <?php if ($currentFile == "all_cources_teacher.php") { ?>class="active"<?php } ?>> <a href="all_cources_teacher.php">-->
