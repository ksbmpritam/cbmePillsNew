...
if (isset($_POST['submit'])) {
  ...
  if (!empty($_POST['sub_category_image'])) {
    ...
    $qry = mysqli_query($mysqli, "update sub_categories set name='" . $_POST['title'] . "',new_line='".$_POST['new_line']."',`desc`='" . $_POST['description'] . "',sub_category_image='" . $sub_category_image . "',category_id='" . $_POST['cat_id'] . "' where id='$cource_id'");
  }else{
    $qry = mysqli_query($mysqli, "update sub_categories set name='" . $_POST['title'] . "',new_line='".$_POST['new_line']."',`desc`='" . $_POST['description'] . "',category_id='" . $_POST['cat_id'] . "' where id='$cource_id'");
  }
  ...
  header("Location:cource_edit_teacher.php?cource_id=" . $cource_id);
