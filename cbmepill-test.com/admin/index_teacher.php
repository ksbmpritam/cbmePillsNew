...
<style>
    body{
        ...
        background-image: url("http://cbmepill.com/assets1/images/back.png");
    }
...
<div class="app app-default">
  <div class="app-container app-login">
    <div class="flex-center">
      <div class="app-body animate__animated animate__backInDown">
        <div class="app-block">
          <div class="app-form login-form">
            <div class="form-header">
              <div class="app-brand"><img src="http://cbmepill.com/assets1/images/logo.png" style="width: 67px;" alt="Logo" class="logo"></div>
            </div>
            ...
            <form action="login_teacher_db.php" method="post">
              ...
              <div class="text-center">
                <input type="submit" class="btn btn-success btn-submit" value="Login">
                   <a  class="btn btn-success btn-submit" href="../index.php" >Home</a>
              </div>
            </form>
          </div>
        </div>
