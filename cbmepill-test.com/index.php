                ...
                <div class="collapse navbar-collapse align-items-center justify-content-end order-3 order-lg-2"
                    ...
                    <ul class="navbar-nav">
						...
						<li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="btn btn-primary" href="https://cbmepill.com/cbmepill-test.com/admin/index_teacher.php" style="margin-left:5px">Teacher Login</a>
                        </li>
						
						<li class="nav-item">
                            <a class="btn btn-primary" href="https://cbmepill.com/cbmepill-test.com/admin/" style="margin-left:5px">Admin Login</a>
                        </li>
