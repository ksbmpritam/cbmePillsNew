...
if($_POST['submit']){
    ...
    header("location:think_higer_template_teacher.php");
        ...
        <div class="card mrg_bottom">
            <div class="page_title_block">
                ...
                <div class="col-md-7 col-xs-12">
                    ...
                    <div class="add_btn_primary"> <a href="create_image_thik_high_teacher.php">Add Create Image Think High</a> </div>
                    </div>
                </div>
            </div>
                                ...
                                while($row = mysqli_fetch_assoc($query)){
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="think_higher_images/<?=$row['image']?>" style="width:150px; height:150px;border:1px solid gray;" class="img-circle">
                                            </td>
                                            <td>
