...
function getStudent($mysqli, $student_id){
    $event_sql = "SELECT * FROM users WHERE id = '$student_id'";
    $event_result = mysqli_query($mysqli, $event_sql);
    $data_title = mysqli_fetch_assoc($event_result);

    $name = $data_title['name'];
    $display_name = $data_title['display_name'];
    $mobile_no = $data_title['mobile'];
    ...
    return empty($name) ? (empty($display_name) ? (!empty($mobile_no) ? $mobile_no : 'N/A') : $display_name) : $name;
}
                                ...
                                <?php
                                    ...
                                    while ($row = mysqli_fetch_assoc($query)) {
                                        ...
                                        <tr id="box<?=$row['id']?>">
                                            ...
                                            <td><?php echo getStudent($mysqli,$row['student_id']);?></td>
