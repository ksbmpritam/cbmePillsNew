                ...
                <form action="" name="addeditcategory" method="post" class="form form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input name="pill_code" type="text" class="form-control" value="<?php echo $last_code; ?>"  disabled>
                        </div>

                        <div class="col-lg-12 col-md-12 col-sm-12" style="display:none;">
                            <label>Pill Description</label>
                            <textarea name="pill_description" type="text" class="form-control" ></textarea>
                        </div>

                        <div class="col-lg-12 col-md-12 col-sm-12" style="display:none;">
                            <label>Pill Benefits</label>
                            <textarea name="pill_benefits" type="text" class="form-control" ></textarea>
                        </div>
