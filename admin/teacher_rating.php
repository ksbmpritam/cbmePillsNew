...
if(isset($_GET['id']) && !empty($_GET['id'])){
    $id = $_GET['id'];
    $sql = "DELETE FROM `rating` WHERE teacher_id='$teacherId'";
...
function getStudent($mysqli, $category_id){
                        ...
                        <table id="mytable"  class="table table-bordered table-striped table-hover table-sm ">
                            ...
                            <tbody >
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM `rating` where teacher_id='$teacherId' ORDER BY id DESC";
