...
if (isset($_POST['submit'])) {
    ...
    header("Location:all_asign_pills_teacher.php");
    exit;
...
?> 
            ...
            <div class="card-body mrg_bottom"> 
                ...
                <img src="images/no_image_selected.png" id="img" style="width:150px;margin: 0 0 20px;height:150px;" class="img-circle">
