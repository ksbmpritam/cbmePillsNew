                        ...
                        <table id="mytable"  class="table table-bordered table-striped table-hover table-sm ">
                            ...
                            <tbody >
                                ...
                                if(isset($_POST['data_search'])){
                                    ...
                                    $sql = "SELECT tc.cid,sc.id,tc.category_name,sc.name,s.slide_id FROM slides s JOIN tbl_category tc JOIN sub_categories sc WHERE s.c_id=tc.cid AND s.sc_id=sc.id GROUP BY sc.id";
                                }
                                ...
                                while($row = mysqli_fetch_assoc($query)){
                                    ?>
                                        <tr id="box<?=$row['id']?>">
                                            ...
                                            <td><?=$row['name']?></td>
                                            <td>
                                                <a  class="add_I_id btn btn-sm btn-info btn-sm" href="all_tiktok_specific.php?cid=<?=$row['cid']?>&sc_id=<?=$row['id']?>">View</a>
                                                <a href="all_think_high.php?id=<?=$row['slide_id']?>" class="remove_I_id btn btn-sm btn-danger btn-sm" >Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                }
