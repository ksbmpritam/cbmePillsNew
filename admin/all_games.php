        ...
        <div class="card mrg_bottom">
            <div class="page_title_block">
              ...
              <div class="search_list">
                ...
                <div class="add_btn_primary"> <a href="add_game.php">Add Game</a> </div>
              </div>
            </div>
                                ...
                                while($row = mysqli_fetch_assoc($query)){
                                    ?>
                                        <tr id="box<?=$row['id']?>">
                                            ...
                                            <td><?=$row['name']?></td>
                                            <td>
                                                <a  class="add_I_id btn btn-sm btn-info btn-sm" href="edit_game.php?id=<?=$row['id']?>&sc_id=<?=$row['sc_id']?>&c_id=<?=$row['c_id']?>">Edit</a>
                                                <a href="add_game.php?id=<?=$row['id']?>" class="remove_I_id btn btn-sm btn-danger btn-sm" >Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                }
