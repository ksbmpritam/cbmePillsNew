        ...
        <div class="card mrg_bottom">
            <div class="page_title_block">
                <div class="col-md-3 col-xs-12">
                    <div class="page_title">Manage Subjects</div>
                </div>
                <div class="col-md-9 col-xs-12">
                    <div class="search_list">
                        <div class="search_block">
                            <form method="post">
                                <input class="form-control input-sm" value="<?=$_POST['search_value']?>" onkeyup="search(this.value)" placeholder="Search Subjects..." aria-controls="DataTables_Table_0" type="search" name="search_value">
                                <button type="button" name="data_search" class="btn-search"><i class="fa fa-search"></i></button>
                            </form>
                        </div>
                        <div class="add_btn_primary"> <a href="add_category.php?add=yes">Add Subject</a> </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="block_wallpaper add_wall_category">
                                    <div class="wall_image_title">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="?cat_id=<?php echo $row['cid']; ?>" data-toggle="tooltip" data-tooltip="Delete" onclick="return confirm('Are you sure you want to delete this Subject?');"><i class="fa fa-trash"></i></a></li>
