        ...
        <div class="card mrg_bottom">
            <div class="page_title_block">
              ...
              <div class="search_list">
                ...
                <div class="add_btn_primary"> <a href="add_pill_benefits_teacher.php">Add Pill Benefits</a> </div>
              </div>
            </div>
                                ...
                                while($row = mysqli_fetch_assoc($query)){
                                    ?>
                                        <tr id="box<?=$row['id']?>">
                                            <td><?=$sno++?></td>
                                            <td><?=$row['pill']?></td>
                                            <td><img src="games_photos/<?=$row['photos']?>" style="width: 150px;height:150px;" class="img-circle"></td>
                                            <td><?=$row['benefits']?></td>
                                            <td>
                                                <a  class="add_I_id btn btn-sm btn-info btn-sm" href="edit_pills_benefits_teacher.php?id=<?=$row['id']?>&image=<?=$row['photos']?>&pill=<?=$row['pill']?>&benefits=<?=$row['benefits']?>&type=<?=$row['type']?>">Edit</a>
                                                <a href="all_pill_benefits_teacher.php?id=<?=$row['id']?>" class="remove_I_id btn btn-sm btn-danger btn-sm" >Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                }
