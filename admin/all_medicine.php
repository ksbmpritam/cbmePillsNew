            ...
            <div class="page_title_block">
                ...
                <div class="col-md-7 col-xs-12">
                    <div class="search_list">
                        ...
                        <div class="add_btn_primary"> <a href="add_medicine.php">Add Pills</a> </div>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    <td><?= $s++; ?></td>
                                    <td><?= $row['name']; ?></td>
                                    <td><img src="medicines/<?= $row['photo']; ?>" style="width: 100px;height:100px;" class="img-circle"></td>
                                    <td>
                                        <button class="btn btn-sm btn-primary" onclick="window.location.href='edit_medicine.php?id=<?= $row['id'] ?>'">Edit</button>
                                        <button class="btn btn-sm btn-danger" onclick="window.location.href='all_medicine.php?del=<?= $row['id'] ?>'">Delete</button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
