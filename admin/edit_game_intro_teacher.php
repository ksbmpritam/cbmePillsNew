...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['file']['name'][0]) && !empty($_FILES['file']['name'][0])) {
        ...
        $sql = "UPDATE `game_intro` SET `c_id`=' $category[category]',`sc_id`='$subcategory',`game_case`='$game_case' WHERE slide_id='$id'";
                            ...
                            <div>
                                ...
                                <select class="form-control"  name="subcategory">
                                    ...
                                    while ($row_sub_cat_id = mysqli_fetch_assoc($query_sub_cat)) {
                                        ?>
                                        <option value="<?= $row_sub_cat_id['id'] ?>"  <?=  $row_get['subid'] == $row_sub_cat_id['id'] ? Selected : ''; ?>><?= $row_sub_cat_id['name'] ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            while($row1 = mysqli_fetch_assoc($query1)){
                                ...
                                if($row1['file_type'] == "video/mp4"){
                                    ...
                                    ?>
                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                            <img src="games_photos/<?=$row1['file']?>" class="all_img img-circle"/>
                                            <i class="fa fa-trash fa-2x delete" title="delete" onclick="deletePhoto(this,'<?=$row1['id']?>')" aria-hidden="true"></i>
                                        </div>
                                    <?php
                                }
