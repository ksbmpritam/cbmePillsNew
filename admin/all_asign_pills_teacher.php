        ...
        <div class="card mrg_bottom">
            <div class="page_title_block">
              ...
              <div class="search_list">
                ...
                <div class="add_btn_primary"> <a href="assign_pill_teacher.php">Asign Pills</a> </div>
              </div>
            </div>
                                ...
                                while($row = mysqli_fetch_assoc($query)){
                                    ?>
                                        <tr id="box<?=$row['id']?>">
                                            ...
                                            <td>
                                                <a  class="add_I_id btn btn-sm btn-info btn-sm" href="edit_asign_pills_teacher.php?id=<?=$row['id']?>&image=<?=$row['photos']?>&pill=<?=$row['pill']?>">Edit</a>
                                                <a href="delete_asign_pill_teacher.php?id=<?=$row['id']?>" class="remove_I_id btn btn-sm btn-danger btn-sm" >Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                }
