                                ...
                                while($row = mysqli_fetch_assoc($query)){
                                    ?>
                                        <tr id="box<?=$row['id']?>">
                                            ...
                                            <td><?=$row['name']?></td>
                                            <td><img src="games_photos/<?=$row['file']?>" style="width: 150px;height: 150px;border:1px solid #c1c1c1;" class="img-circle"></td>
                                            <td>
                                                <a  class="add_I_id btn btn-sm btn-info btn-sm" href="all_game_intro_specific.php?sub_id=<?=$row['sub_id']?>&cid=<?=$row['cid']?>">View</a>
                                                <a href="all_game_intro.php?id=<?=$row['id']?>" class="remove_I_id btn btn-sm btn-danger btn-sm" >Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                }
