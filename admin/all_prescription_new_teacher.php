        ...
        <div class="card mrg_bottom">
            <div class="page_title_block">
              ...
              <div class="search_list">
                ...
                <div class="add_btn_primary"> <a href="add_prescription_new_teacher.php">Add Prescription</a> </div>
              </div>
            </div>
                                ...
                                while($row = mysqli_fetch_assoc($query)){
                                    ?>
                                        <tr id="box<?=$row['id']?>">
                                            ...
                                            <td><?=$row['kase']?></td>
                                            <td>
                                                <a  class="add_I_id btn btn-sm btn-info btn-sm" href="all_specific_prescrition_new_teacher.php?cid=<?=$row['cid']?>&sc_id=<?=$row['sub_cat']?>">View</a>
                                                <a href="all_prescription_new_teacher.php?cid=<?=$row['cid']?>&sc_id=<?=$row['sub_cat']?>" class="remove_I_id btn btn-sm btn-danger btn-sm" >Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                }
