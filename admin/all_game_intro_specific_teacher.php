                                ...
                                while($row = mysqli_fetch_assoc($query)){
                                    ?>
                                        <tr id="box<?=$row['id']?>">
                                            ...
                                            <td>
                                                <?php
                                                    ...
                                                    if($ext == "jpg" || $ext == "png" || $ext == "jpeg" || $ext == "gif"){
                                                        ?>
                                                            <img src="games_photos/<?=$row['file']?>" style="width: 150px;height: 150px;border:1px solid #c1c1c1;" class="img-circle">
                                                        <?php
                                                    }else{
                                                        ?>
                                            ...
                                            <td>
                                                <a  class="add_I_id btn btn-sm btn-info btn-sm" href="edit_game_intro_teacher.php?sub_id=<?=$row['sub_id']?>&cid=<?=$row['cid']?>&id=<?=$row['id']?>&slide_id=<?=$row['slide_id']?>">Edit</a>
                                                <a href="all_game_intro_specific_teacher.php?id=<?=$row['id']?>" class="remove_I_id btn btn-sm btn-danger btn-sm" >Delete</a>
