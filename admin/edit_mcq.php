...
$id = filter($_GET['id']);
$sql = "SELECT m.id,m.title_text,sc.name,tc.category_name,m.title_img,m.options,m.right_option,m.timer,m.why_ans_mcq FROM `mcq` m JOIN tbl_category tc JOIN sub_categories sc WHERE m.c_id=tc.cid AND m.sc_id=sc.id AND m.id='$id'";
                            ...
                            <div class="row px-2">
                                        ...
                                        <select class="form-control" onchange="getSubCategory()" id="category" name="category">
                                            <?php
                                                ...
                                                while($row = mysqli_fetch_assoc($query)){
                                                    ...
                                                    if($old_data['category_name'] == $row['category_name']){
                                                        $selected = "selected";
                                                    }else{
                                                        $selected = "";
                                                    }
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 top_margin">
                                    <div>
                                        ...
                                        <img src="mcq_images/<?=$old_data['title_img']?>" style="width:150px;height:150px;border:1px solid #c1c1c1;" class="img-circle">
                                    </div>
                                </div>
                                ...
                                <?php
                                    ...
                                    if(isset($options_is_images)){
                                        ...
                                        foreach($options_is_images as $img){
                                            ...
                                            ?>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <img src="mcq_images/<?=$img?>" style="width:150px;height:150px;border:1px solid #c1c1c1;" class="img-circle">                                                
