...
if (isset($_POST['submit'])) {
    ...
    if(mysqli_query($mysqli,$sql)){
        ...
        header("Location:all_pill_benefits.php");
        exit;
    }
...
?> 
            ...
            <div class="card-body mrg_bottom"> 
                ...
                <img src="games_photos/<?=$image?>" id="img" style="width:150px;margin: 0 0 20px;height:150px;border:1px solid gray" class="img-circle">
