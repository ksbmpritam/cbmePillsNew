                                ...
                                while($row = mysqli_fetch_assoc($query)){
                                    ?>
                                        <tr id="box<?=$row['id']?>">
                                            ...
                                            <td><?=$row['name']?></td>
                                            <td>
                                                <a  class="add_I_id btn btn-sm btn-info btn-sm" href="all_tiktok_specific_teacher.php?cid=<?=$row['cid']?>&sc_id=<?=$row['id']?>">View</a>
                                                <a href="all_think_high_teacher.php?id=<?=$row['slide_id']?>" class="remove_I_id btn btn-sm btn-danger btn-sm" >Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                }
