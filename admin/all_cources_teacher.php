...
if (isset($_POST['data_search'])) {
    ...
    $qry = "SELECT * FROM sub_categories WHERE name LIKE '%".$_POST['search_value']."%' ORDER BY id DESC";
    
    $result = mysqli_query($mysqli, $qry);
} else {

    $qry = "SELECT * FROM sub_categories where teacher_id=$teacherId ORDER BY id DESC";
        ...
        <div class="card mrg_bottom">
            <div class="page_title_block">
                <div class="col-md-5 col-xs-12">
                    <div class="page_title">Manage Lesson</div>
                </div>
                <div class="col-md-7 col-xs-12">
                    <div class="search_list">
                        <div class="search_block">
                            <form method="post" action="">
                                <input class="form-control input-sm" placeholder="Search Lesson ..." aria-controls="DataTables_Table_0" onkeyup="search(this.value)" type="search" name="search_value" required>
                                <button type="button" name="data_search" class="btn-search"><i class="fa fa-search"></i></button>
                            </form>
                        </div>
                        <div class="add_btn_primary"> <a href="add_course_teacher.php?add=yes">Add Lesson</a> </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="block_wallpaper add_wall_category">
                                <div class="wall_image_title">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="cource_edit_teacher.php?cource_id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-tooltip="Edit"><i class="fa fa-edit"></i></a></li>
