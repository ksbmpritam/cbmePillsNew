          ...
          <div class="page_title_block">
            ...
            <div class="col-md-7 col-xs-12">
              <div class="search_list">
                ...
                <div class="add_btn_primary"> <a href="send_notification.php">Send Notification</a> </div>
              </div>
            </div>
    ...
    <tbody>
        ...
        ?>
              <tr>
                ...
                <td>
                    <!--<img src="<?=$row['image'];?>" style="width: 100px !important;">-->
                <img 
                    src="<?=$row['image'];?>" 
                    style="width: 100px; height: 100px; border: 1px solid #c1c1c1;" 
                    class="img-circle" 
...
<script>
    ...
    function handleImageError(img) {
        img.onerror = null;
        img.src = 'https://cbmepill.com/admin/images/error/504708-200.png';
    }
</script>
