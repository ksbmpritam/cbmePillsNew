            ...
            <div class="page_title_block">
                ...
                <div class="col-md-3 col-xs-12">
                  <div class="search_list">
                    ...
                    <div class="add_btn_primary"> <a href="bulk_mcq.php">Bulk Upload</a> </div>
                  </div>
                </div>
              ...
              <div class="search_list">
                ...
                <div class="add_btn_primary"> <a href="add_mcq.php">Add MCQ</a> </div>
              </div>
            </div>
                                ...
                                while($row = mysqli_fetch_assoc($query)){
                                    ?>
                                        <tr>
                                            ...
                                            <td><?=$row['name']?></td>
                                            <td>
                                                <a  class="add_I_id btn btn-sm btn-info btn-sm" href="edit_mcq.php?id=<?=$row['id']?>">Edit</a>
                                                <a href="all_mcq.php?id=<?=$row['id']?>" class="remove_I_id btn btn-sm btn-danger btn-sm" >Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                }
